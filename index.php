...
<html lang="en" class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title> "CV2023" Frontend Armando</title>
                    ...
                    <div class="collapse navbar-collapse nav-collapse">
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right">
                                ...
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="#work">Trabalho</a></li>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="promo-block-divider">
                            <h1 class="promo-block-title">Armando <br/> Muchuine</h1>
                            <p class="promo-block-text">tecnico informatica &amp; Full-Stack Developer</p>
                        </div>
                        <ul class="list-inline">
                            <li><a href="https://web.facebook.com/mario.muchuine" class="social-icons"><i class="icon-social-facebook"></i></a></li>
                            <li><a href="https://web.facebook.com/mario.muchuine" class="social-icons"><i class="icon-social-twitter"></i></a></li>
                            <li><a href="https://web.facebook.com/mario.muchuine" class="social-icons"><i class="icon-social-dribbble"></i></a></li>
                            <li><a href="https://web.facebook.com/mario.muchuine" class="social-icons"><i class="icon-social-behance"></i></a></li>
                            <li><a href="https://web.facebook.com/mario.muchuine" class="social-icons"><i class="icon-social-linkedin"></i></a></li>
                        </ul>
                    </div>
                </div>
                <!--// end row -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-sm-offset-1">
                        <div class="margin-b-60">
                            <p>Armando Muchuine,faço montagem e manutenção de computadores, detecção e correção de problemas nos sistemas, instalação e configuração de redes, aplicativos, programas e softwares, além de desenvolvimento de sistemas e websites </p>
                        </div>
                                    ...
                                    <div class="work-popup-overlay">
                                        <div class="work-popup-content">
                                            ...
                                            <div class="margin-b-30">
                                                <h3 class="margin-b-5">Arte de Codificar</h3>
            ...
            <div class="bg-color-sky-light">
                <div class="container content-lg">
                    <div class="row">
                        <div class="col-sm-3 sm-margin-b-30">
                            <div class="text-right sm-text-left">
                                <h2 class="margin-b-0">Contactos</h2>
                                <p>aqui estao</p>
                            </div>
                        </div>
                        <div class="col-sm-8 col-sm-offset-1">
                            <div class="row">
                                <div class="col-md-3 col-xs-6 md-margin-b-30">
                                    <h5>Localizacao</h5>
                                    <a href="http://keenthemes.com/">Maputo, Matola</a>
                                </div>
                                <div class="col-md-3 col-xs-6 md-margin-b-30">
                                    <h5>Phone</h5>
                                    <a href="http://keenthemes.com/">+258845205081</a>
                                </div>
                                <div class="col-md-3 col-xs-6">
                                    <h5>Email</h5>
                                    <a href="mailto:#">mario.mendes1792@gmail.com</a>
                                </div>
                                <div class="col-md-3 col-xs-6">
                                    <h5>Web</h5>
                                    <a href="http://keenthemes.com/">mario.mendes1792@gmail.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content container">
                <div class="row">
                    ...
                    <div class="col-xs-6 text-right sm-text-left">
                        <p class="margin-b-0"><a class="fweight-700" href="http://keenthemes.com/preview/aircv/">SOFTEC</a>  Powered by: <a class="fweight-700" href="http://www.keenthemes.com/">mario.mendes1792@gmail.com.com</a></p>
                    </div>
                </div>
                <!--// end row -->
            </div>
